...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'accesspress-store' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'accesspress-store' ),
		'repeat-y'  => __( 'Repeat Vertically', 'accesspress-store' ),
		'repeat'    => __( 'Repeat All', 'accesspress-store' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'accesspress-store' ),
		'top center'    => __( 'Top Center', 'accesspress-store' ),
		'top right'     => __( 'Top Right', 'accesspress-store' ),
		'center left'   => __( 'Middle Left', 'accesspress-store' ),
		'center center' => __( 'Middle Center', 'accesspress-store' ),
		'center right'  => __( 'Middle Right', 'accesspress-store' ),
		'bottom left'   => __( 'Bottom Left', 'accesspress-store' ),
		'bottom center' => __( 'Bottom Center', 'accesspress-store' ),
		'bottom right'  => __( 'Bottom Right', 'accesspress-store')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'accesspress-store' ),
		'fixed'  => __( 'Fixed in Place', 'accesspress-store')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'accesspress-store' ),
		'italic'      => __( 'Italic', 'accesspress-store' ),
		'bold'        => __( 'Bold', 'accesspress-store' ),
		'bold italic' => __( 'Bold Italic', 'accesspress-store' )
		);
